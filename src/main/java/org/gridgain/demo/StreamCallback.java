...
public class StreamCallback extends SubscribeCallback {
    ...
    private final IgniteCache<TradeKey, Trade> tradeCache;
    ...
    public void status(PubNub nub, PNStatus status) {
        ...
        if (status.getCategory() == PNStatusCategory.PNConnectedCategory) {
            // Connect event.
            System.out.println("Connected to the market orders stream: " + status);
            ...
            System.out.println("Connection status changes:" + status);
        }
    }
